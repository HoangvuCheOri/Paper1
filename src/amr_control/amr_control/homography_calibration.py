...
WORLD_POINTS = [  # real-world coordinates in meters (BẠN HÃY ĐIỀN VÀO ĐÂY)
    [1.1, 0.0],  # Tọa độ thực cho điểm [932, 363] 1
    [0.0, 0.0],  # Tọa độ thực cho điểm [670, 370] 2
    [1.1, 1.1],  # Tọa độ thực cho điểm [913, 113] 3
    [0.0, 1.1],  # Tọa độ thực cho điểm [662, 114] 4
    [-1.1, 1.1],  # Tọa độ thực cho điểm [412, 127] 5
    [-1.1, 0.0],  # Tọa độ thực cho điểm [404, 376] 6
    [-1.1, -1.1],  # Tọa độ thực cho điểm [411, 637] 7
    [0.0, -1.1],  # Tọa độ thực cho điểm [674, 641] 8
    [1.1, -1.1],  # Tọa độ thực cho điểm [935, 627] 9
    [0.5, 0.0],  # Tọa độ thực cho điểm [804, 366] 10
    [-0.5, 0.0],  # Tọa độ thực cho điểm [533, 373] 11
    [0.5, 0.5],  # Tọa độ thực cho điểm [799, 235] 12
    [-0.5, 0.5],  # Tọa độ thực cho điểm [532, 244] 13
    [-0.5, -0.5],  # Tọa độ thực cho điểm [535, 508] 14
    [0.5, -0.5],  # Tọa độ thực cho điểm [809, 505] 15
    [0.0, -0.5],  # Tọa độ thực cho điểm [671, 508] 16
    [0.0, 0.5],  # Tọa độ thực cho điểm [666, 235] 17
]
