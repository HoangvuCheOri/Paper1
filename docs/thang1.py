...
class BSMCEight(Node):
    ...
    Quỹ đạo dùng một pha bắt đầu có thể cấu hình. Profile phần cứng bắt đầu tại
    pha 45 deg, rồi dịch toàn bộ quỹ đạo để pose ban đầu vẫn là (x0, y0).
    Tiếp tuyến tại điểm đó là 0 deg, vì vậy xe đặt ở yaw=0 có thể chạy ngay mà
    không quay tại chỗ. Pha bắt đầu chỉ đổi điểm bắt đầu của cùng đường số 8.
    """
    ...
    def __init__(self):
        ...
        self.declare_parameter('start_phase_deg', 45.0)
